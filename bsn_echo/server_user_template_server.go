...
// func (this *SServerUserTemplate) procServerMsg(msgType bsn_msg_gate_gateconfig.ECmdGateConfig2Gate) error {
...
// func (this *SServerUserTemplate) ProcMsg_CmdGateConfig2Gate_GetServerConfigRes() (err error) {
